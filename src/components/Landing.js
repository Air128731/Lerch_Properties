        ...
        <div className='relative w-full h-full body'>
          ...
          <div className='grid grid-cols-3 py-20 text-lg font-bold text-gray-600 _md:grid-cols-1 fadeInRight' style={{backgroundImage: "url('https://lerchproperties.net/wp-content/uploads/2023/06/Lerch-Properties-3.webp')"}}>
            <div className='flex justify-center'>
              <div className='flex flex-col items-start justify-start'>
                <div className='flex flex-row items-center gap-2 p-2 text-2xl text-gray-700 rounded-lg'>Why Choose Us?</div>
            ...
            <div className='flex justify-center _md:py-10'>
              <div className='flex flex-col'>
                <div className='p-2 text-xl text-gray-700 rounded-lg'>We are Committed to High Standard and Quality Values</div>
            ...
            <div className='flex justify-center'>
              <div className='flex flex-col items-start justify-start'>
                <div className='flex flex-row items-center gap-2 p-2 text-2xl text-gray-700 rounded-lg'>Business Hours</div>
          ...
          <div className='flex flex-col py-10 bg-gray-200 fadeInLeft'>
            ...
            <div className='flex flex-row justify-center gap-60 _md:flex-col _md:gap-0'>
              <div className="card">
                <div className="text-gray-500 bg-white cardheader">
                ...
                <div className="text-xl font-bold text-gray-700 cardcontainer">
                  <p>Catherine S.</p>
                </div>
              </div>
              <div className="card">
                <div className="text-gray-500 bg-white cardheader" style={{paddingBottom: "40px", paddingTop: "30px"}}>
