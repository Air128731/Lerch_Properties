                ...
                <div className='flex flex-col items-center justify-center'>
                    ...
                    <div className='grid w-full grid-cols-2'>
                        <div>
                            ...
                            <div className='font-bold text-gray-500'>2921 N. Center St. Suite 6</div>
                            <div className='font-bold text-gray-500'>Maryville, IL 62062</div>
                        </div>
                        <div>
                            <div className='py-3 text-2xl font-bold text-gray-700'>Call or Email</div>
                            <div className='font-bold text-gray-500'>(618) 288-3108</div>
                            <div className='font-bold text-gray-500'>info@lerchproperties.net</div>
                        </div>
                    </div>
                </div>
            </div>
