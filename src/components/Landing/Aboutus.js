  ...
  return (
    <>
        <div className="flex-col w-1/3 p-4 text-left bg-gray-100 rounded-lg AboutusItem" style={{width: "450px", boxShadow: "0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)"}}>
            <div></div>
            <div>
                <div className="flex flex-row items-center gap-3 text-2xl font-bold leading-8 text-gray-600">
                    <div className="p-2.5 rounded-md bg-gray-600">
                ...
                <br></br>
                <div className="leading-8 text-gray-700 text-md">{props.content}</div>
            </div>
        </div>
    </>
  );
